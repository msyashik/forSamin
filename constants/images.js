...
const ferrarif60america = require("../assets/images/ferrarif60america.jpg");
const ferrariLaferri = require("../assets/images/ferrarilaferrari.jpg");
const hanssey = require("../assets/images/hennessey-venom-f5.jpg");
const pag = require("../assets/images/pagani-huayra.jpg");
const koen1 = require("../assets/images/koenigsegg-jesko.jpg");
const koen2 = require("../assets/images/koenigsegg-regera-one-1.jpg");
const battista = require("../assets/images/pininfarina-battista.jpg");
const zenvo = require("../assets/images/zenvo-tsr-s.jpg");
export default {
  koen1,
  koen2,
  battista,
